...
7. **Gate G1 (job ready):** separate 40-game paired standard-play and sampled-placement full-game arenas versus Run13 at equal 96/128 simulations. Selection seed `20260901`, FP32, exact canonical 1/1 standard/placement root inference for P1c, native evaluation-time 8/8 root symmetry evaluation for Run13, and full-game placement temperature 1 are frozen. A pre-game batch-eight calibration supplies supplementary asymmetric equal-cost arenas without inspecting outcomes and includes Run13's seven extra root evaluations per move in predicted cost. Both standard gates must score at least 35% with paired lower bounds above the 20% stop region; any primary score below 20%, or a significant absolute standard/full gap of at least 15 points, stops for debugging. Otherwise the result is inconclusive. Final data remain untouched.
